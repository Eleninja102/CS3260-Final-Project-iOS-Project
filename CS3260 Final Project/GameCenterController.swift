...
//	@Attribute var playingGame = false
//	
//	@Attribute var matchAvailable = false
//	@Attribute var maxPlayers = 2
//	@Attribute var minPlayers = 2
//	var userPlayer: Player? = nil
////	@Published var userPlayer: Player = Player(playerName: "Bpb")
//	@Attribute var user: GKLocalPlayer? = nil
//	var savedGames: [GameData] = []
////	@Published var activeGame: GameData? = GameData(matchName: "bob"
//	var activeGame: GameData? = nil
//
//	@Attribute var gameSaveName: String = ""
//	
...
//	init(playingGame: Bool = false, matchAvailable: Bool = false, maxPlayers: Int = 2, minPlayers: Int = 2, userPlayer: Player? = nil, user: GKLocalPlayer? = nil, savedGames: [GameData], activeGame: GameData? = nil, gameSaveName: String, oxygenRange: barControls, tempetureRange: barControls = barControls(range: -30...8, increament: 2, purpleRange: -30...(-20), redRange: -18...(-10), yellowRange: -8...0, whiteRange: 2...8), oceansRange: barControls = barControls(range: 1...9, increament: 1, purpleRange: 0...1, redRange: 2...4, yellowRange: 5...7, whiteRange: 8...9)) {
...
//		self.gameSaveName = gameSaveName
//		self.oxygenRange = oxygenRange
//		self.tempetureRange = tempetureRange
//		self.oceansRange = oceansRange
//	}
//	
//	var userName: String {
...
//	}
//	
//	func startMatchmaking(activeGame: GameData){
//		let request = GKMatchRequest()
//		request.minPlayers = minPlayers
//		request.maxPlayers = maxPlayers
